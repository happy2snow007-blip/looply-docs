...
1. 《Looply-v1.4-详细埋点需求定稿-v1.2》：事件、页面、模块、动作、触发时机、业务参数及存量处理的唯一权威表。
...
- `result_state`和`failure_type`的逐动作适用范围，以《Looply-v1.4-详细埋点需求定稿-v1.2》工作簿“详细点位”Sheet中对应行的“成立时机”和“专属参数”为唯一依据。

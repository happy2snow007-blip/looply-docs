...
| PC Wishlist Drawer首次展示非空商品 | 发送1条列表展示 |
| PC Wishlist Drawer筛选或Tab形成不同结果 | 发送1条新列表展示 |
| PC Wishlist Drawer滚动追加或相同结果重开 | 0条列表展示 |
| PC Wishlist Drawer点击商品 | 发送1条商品点击，关联当前列表 |

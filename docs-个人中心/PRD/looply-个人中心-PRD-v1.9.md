...
| C 端原型 | `looply-个人中心-APP-v6.pen` | 页面、字段、平台差异、登录态与多市场设置以此为准；新增移动端昵称为空 Case |
...
> 冲突优先级：本 PRD 已确认决策 > V6 原型（前端页面、字段、文案、交互、平台差异与登录态）> ER v1.6（实体、字段、关系与数据规则）> 收藏与浏览历史 PRD v1.6 > 客户咨询后台原型 v2 > 功能清单 v1.8 > 旧资料。前端范围按 V6；旧资料中的“Market 等同国家、收藏/浏览仅靠 listing 推导地域、仅美国、Region 无入口、USD/EUR 固定选项”、独立 Settings 壳、匿名合并后清空等口径不再沿用。
...
**UI 关联**：`looply-个人中心-APP-v6.pen` 中的 `V5-移动端-个人中心-响应式统一版`、`V6-移动端-个人中心-昵称为空Case`、`V5-PC-个人中心-响应式统一版`、`V5-移动端-退出登录后`、`V5-PC-退出登录后`。
...
|---|---|---|
| 个人中心首页 | `looply-个人中心-APP-v6.pen`：V5-移动端-个人中心-响应式统一版 / V6-移动端-个人中心-昵称为空Case | `looply-个人中心-APP-v6.pen`：V5-PC-个人中心-响应式统一版 |
...
- C 端原型：`~/Desktop/个人中心/原型/looply-个人中心-APP-v6.pen`

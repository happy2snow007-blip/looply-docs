...
| Your Privacy Choices | 本 PRD 第六节、UI 最终稿及法务最终文案 | 自建页面及正式站内路由就绪后接入 |
...
| 说明文案 1 | `Looply uses cookies and similar technologies to improve your experience, understand site usage, and support advertising. We may also share certain personal information with advertising partners to provide more relevant advertising.` | `privacy_choices.card.description_usage` | 无 |
| 说明文案 2 | `Depending on where you live, these activities may be considered a “sale,” “sharing,” or “targeted advertising” under applicable U.S. privacy laws. You may have the right to opt out of these activities.` | `privacy_choices.card.description_rights` | 无 |
...
| Your Privacy Choices | Your Privacy Choices Web Demo v0.1 | UI 提供正式稿；法务确认文案；补充正式站内路由 |

...
**端**：APP + PC Web
**配套**：个人中心 PRD v1.2、个人中心 ER 图 v1.6、功能清单 v1.8、收藏与浏览历史 ER 图 v1.5；当前 UI 基线为 [Looply 1.1 移动端](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=552-1761&p=f&m=dev) 与 [Looply 1.1 PC 端](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=550-950&p=f&m=dev)。

> **v1.7 变更摘要**（UI 设计稿迁移）：收藏与浏览历史的当前 UI 参考统一切换为 Looply 1.1 Figma：移动端节点 `552:1761`、PC 端节点 `550:950`。本地 `.pen` 不再作为当前 UI 基线，仅保留历史追溯价值；本次不调整业务规则、数据模型或验收口径。
...
**UI 关联**：PC "View More"按钮见 `PC-收藏列表` / `PC-浏览历史` 底部；PC 抽屉滚动加载见 `PC-收藏抽屉`；移动端无更多数据反馈复用移动端全局列表交互规范。以本 PRD 关联的 Looply 1.1 Figma 当前页面为验收 UI 基线。
...
| 页面 | 移动端 Figma | PC 端 Figma |
|---|---|---|
| 收藏列表（四态） | [Looply 1.1 · 节点 552:1761](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=552-1761&p=f&m=dev) | [Looply 1.1 · 节点 550:950](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=550-950&p=f&m=dev) |
| PC 收藏抽屉（带筛选滚动列表） | （移动端无，进整页瀑布流列表） | [Looply 1.1 · 节点 550:950](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=550-950&p=f&m=dev) |
| 浏览历史（纯倒序） | [Looply 1.1 · 节点 552:1761](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=552-1761&p=f&m=dev) | [Looply 1.1 · 节点 550:950](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=550-950&p=f&m=dev) |
| 收藏空态 | [Looply 1.1 · 节点 552:1761](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=552-1761&p=f&m=dev) | [Looply 1.1 · 节点 550:950](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=550-950&p=f&m=dev) |
| 浏览历史空态 | [Looply 1.1 · 节点 552:1761](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=552-1761&p=f&m=dev) | [Looply 1.1 · 节点 550:950](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=550-950&p=f&m=dev) |
| 商详页"最近浏览"横条 | （归商详页模块设计） | （归商详页模块设计） |

当前设计源：移动端 [Looply 1.1（节点 552:1761）](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=552-1761&p=f&m=dev)；PC 端 [Looply 1.1（节点 550:950）](https://www.figma.com/design/sAOLkw0gIl1bwQRYCDqKuW/Looply-1.1?node-id=550-950&p=f&m=dev)。
...
> **v1.7 配套同步结果**：专项 ER v1.5、个人中心 PRD v1.2、个人中心 ER v1.6 与功能清单 v1.8 的业务口径不变；前端 UI 验收改以 Looply 1.1 Figma 两端节点为准。

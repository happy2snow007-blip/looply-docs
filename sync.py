    ...
    'data_tracking': {
        ...
        'static_docs': [
            ...
            },
            {
                'source_subdir': 'docs/product',
                'subdir': '一方平台开发基线',
                'filename': 'looply-订单与交易数据接入-后端事件契约-v1.1.md',
            },
            {
                'source_subdir': 'docs/product',
                'subdir': '版本说明',
            ...
            },
            {
                'source_subdir': 'docs/product',
                'subdir': 'GA4开发基线',
                'filename': 'looply-GA4全量事件清单-v1.0.md',
            },
            {
                'source_subdir': 'docs/reviews/C端数据看板',
                'subdir': 'GA4开发基线',
    ...
    'c1_sell': {
        ...
        'static_docs': [
            ...
            },
            {
                'source_subdir': 'docs/product',
                'subdir': 'PRD',
                'filename': 'looply-C1-Sell-数据采集与GA4需求-v0.9.md',
            },
            {
                'source_subdir': 'docs/product',
                'subdir': 'PRD',
            ...
            },
            {
                'source_subdir': 'docs/product',
                'subdir': 'PRD',
                'filename': 'looply-C1-Sell-数据采集与GA4需求-v1.4.md',
            },
            {
                'source_subdir': 'docs/product',
                'subdir': 'PRD',
            ...
            },
            {
                'source_subdir': 'docs/product',
                'subdir': 'PRD',
                'filename': 'looply-C1-Sell-埋点开发输入清单-20260911-v1.2.md',
            },
            {
                'source_subdir': 'docs/product',
                'subdir': '评审记录',
            ...
            },
            {
                'source_subdir': 'docs/product',
                'subdir': '评审记录',
                'filename': 'looply-C1-Sell-开发反馈产品处理结论-20260911-v1.2.md',
            },
            {
            ...
            {
                'source_subdir': 'outputs/c1-sell-data-20260911-v1.2',
                'subdir': '开发清单',
                'filename': 'looply-C1-Sell-埋点开发清单-v1.2.xlsx',
            },
        ],
        'artifacts': {
            'prototype': {

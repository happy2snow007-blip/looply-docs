...
| 页面 | 设计稿 |
|------|--------|
| 订单列表 | 后台原型: looply-订单管理后台原型-v13.html — OrderListPage |
| 订单详情 | 后台原型: looply-订单管理后台原型-v13.html — OrderDetailPage |
...
| 页面 | 设计稿 |
|------|--------|
| 弃单列表 | 后台原型: looply-订单管理后台原型-v13.html — AbandonedCartPage |
| 弃单详情 | 后台原型: looply-订单管理后台原型-v13.html — AbandonedDetailPage |
| 导出弹窗 | 后台原型: looply-订单管理后台原型-v13.html — AbandonedCartPage 导出弹窗（形态复用 ReconciliationPage）|
...
| 页面 | 设计稿 |
|------|--------|
| 支付单列表 | 后台原型: looply-订单管理后台原型-v13.html — PaymentOrderListPage |
...
| 页面 | 设计稿 |
|------|--------|
| 退款单列表 | 后台原型: looply-订单管理后台原型-v13.html — RefundOrderListPage |
...
| 页面 | 设计稿 |
|------|--------|
| 支付流水列表 | 后台原型: looply-订单管理后台原型-v13.html — PaymentTransactionListPage |
...
| 页面 | 设计稿 |
|------|--------|
| 对账管理列表 | 后台原型: looply-订单管理后台原型-v13.html — ReconciliationPage |
...
| 文件 | 说明 |
|------|------|
| looply-订单管理后台原型-v13.html | 后台 8 个页面（订单管理、弃单管理、支付单管理、支付流水、对账管理、退款单管理） |

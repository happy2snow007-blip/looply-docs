...
每个资源类型在导航页显示为一张卡片，有两种状态：
- **已对接**（实线卡片）：业务模块已完成翻译服务对接，卡片可点击进入翻译详情页，显示翻译进度
- **占位**（虚线卡片）：资源类型已规划但业务模块尚未对接，卡片不可点击，无翻译进度。业务模块完成对接后自动切换为实线状态

| 域 | resource_type | 显示名称 | 对接状态 |
|----|--------------|---------|---------|
| 商品域 | listing | 渠道商品 | 已对接 |
| 商品域 | product | 实物商品 | 已对接 |
| 商品域 | spu | 标品SPU | 已对接 |
| 商品域 | sku | 标品SKU | 已对接 |
| 商品域 | category | 类目 | 已对接 |
| 商品域 | brand | 品牌 | 已对接 |
| 商品域 | series | 系列 | 已对接 |
| 商品域 | attribute | 属性 | 已对接 |
| 商品域 | attribute_option | 属性选项 | 已对接 |
| 商品域 | enum | 成色等级 | 已对接 |
| 前端页面 | page-auth | 登录注册 | 占位 |
| 前端页面 | page-home | 首页 | 占位 |
| 前端页面 | page-collection | 集合页 | 占位 |
| 前端页面 | page-pdp | 商详页 | 占位 |

 ...
 *
 * 更新原型版本时只改这个文件，index.html 和 admin.html 自动同步。
 *
 * 使用方式：
...
var PROTOTYPE_CONFIG = {
  'product':     'docs-商品系统/原型/looply-商品管理后台原型-v32-风格A-活力亲和.html',
  'market':      'docs-market系统/原型/looply-market后台原型-v20.html',
  'inventory':   'docs-库存管理/原型/looply-库存管理后台原型-v6-风格A-活力亲和.html',
